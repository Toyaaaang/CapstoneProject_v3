...
export default function ChargeTicketItemsPage() {
  ...
  // Release handler for the whole ticket
  const handleRelease = async () => {
    try {
      await axios.post(`/requests/charge-tickets/${id}/release/`);
      toast.success("Charge ticket marked as released.");
      router.back();
    } catch {
  ...
  return (
    <div className="w-full mx-auto p-6">
      ...
      <div className="flex gap-2 mt-4">
        ...
        <ConfirmActionDialog
          trigger={<Button><Check /> Confirm Release</Button>}
          title="Mark as Released?"
          description="Are you sure you want to mark this charge ticket as released? This cannot be undone."
