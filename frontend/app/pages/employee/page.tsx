...
export default function OoperationsMaintainanceOverview() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const dummyUser = { role: "employee" }; // Simulate a logged-in user with the correct role
      setUser(dummyUser);
      setLoading(false);
      ...
      <div className="flex flex-1 flex-col">
          <div className="@container/main flex flex-1 flex-col gap-2">
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              {user && <SectionCards role={user.role} />}
