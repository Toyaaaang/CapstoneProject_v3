...
export default function SalvageReturnForm() {
  ...
  return (
    <Card className="p-6 space-y-4">
      <h2 className="text-lg font-semibold">Salvage Return Form</h2>
      ...
      <div className="space-y-2">
        ...
        {materials.map((mat, idx) => (
          <div key={idx} className="flex flex-wrap gap-2 items-center border p-3 rounded">
            <Input
            ...
            />
            <Button type="button" variant="destructive" size="icon" onClick={() => removeMaterial(idx)}>
              ✕
            </Button>
          </div>
        ))}
